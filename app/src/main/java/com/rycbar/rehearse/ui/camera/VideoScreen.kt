...
@Composable
fun ViewFinderSubScreen(modifier: Modifier, state: RehearseState, onEvent: (MainEvent) -> Unit) {
...
@Composable
private fun ViewFinderOverlay(colorScheme: ColorScheme, state: RehearseState, onEvent: (MainEvent) -> Unit) {
